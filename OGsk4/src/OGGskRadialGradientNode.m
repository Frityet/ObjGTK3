...
{
	GskRadialGradientNode* gobjectValue = GSK_RADIAL_GRADIENT_NODE(gsk_radial_gradient_node_new(bounds, center, hradius, vradius, start, end, colorStops, ncolorStops));
...
{
	return GSK_RADIAL_GRADIENT_NODE([self gObject]);
}
