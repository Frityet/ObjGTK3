 ...
 */
- (void)bindWithMappingClosuresWithKey:(OFString*)key object:(GObject*)object property:(OFString*)property flags:(GSettingsBindFlags)flags getMapping:(GClosure*)getMapping setMapping:(GClosure*)setMapping;
