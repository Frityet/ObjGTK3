...
- (void)featuresWithFeatures:(gconstpointer)features len:(guint)len numFeatures:(guint*)numFeatures
{
...
- (gconstpointer)hbFont
{
	gconstpointer returnValue = pango_font_get_hb_font([self castedGObject]);
