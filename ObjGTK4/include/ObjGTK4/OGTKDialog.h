 ...
 */
- (void)addActionWidgetWithChild:(OGTKWidget*)child responseId:(GtkResponseType)responseId;
 ...
 */
- (OGTKWidget*)addButtonWithButtonText:(OFString*)buttonText responseId:(GtkResponseType)responseId;
 ...
 *   @response_id
 */
- (OGTKWidget*)widgetForResponse:(GtkResponseType)responseId;
 ...
 */
- (void)response:(GtkResponseType)responseId;
 ...
 */
- (void)setDefaultResponse:(GtkResponseType)responseId;
 ...
 */
- (void)setResponseSensitiveWithResponseId:(GtkResponseType)responseId setting:(bool)setting;
